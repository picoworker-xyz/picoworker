    ...
    <Page title={`Welcome back, ${profile.display_name}`} subtitle="Pick a task and get paid in USDC.">
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 order-2 lg:order-1">
          ...
          {filtered.length === 0 ? (
            <div className="text-center text-[#767884] text-[14px] font-semibold py-16 rounded-[18px] border border-white/6 bg-[#15161C]">
              No tasks here right now. Check back soon!
            </div>
          ) : (
