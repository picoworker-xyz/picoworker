...
const CpaleadOffers = lazy(() => import('./features/earner/CpaleadOffers').then((m) => ({ default: m.CpaleadOffers })))
...
export default function App() {
  return (
    ...
    <Routes>
      ...
      <Route path="/offers/featured" element={<Shell><CpaleadOffers /></Shell>} />
